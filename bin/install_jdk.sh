...
do
    ssh ${AUSER:?}@${PREFIX}-${host}.${DOMAIN} 'sudo wget -P /etc/yum.repos.d/ https://archive.cloudera.com/director/redhat/7/x86_64/director/cloudera-director.repo && sudo yum -y install oracle-j2sdk1.8.x86_64'
done
